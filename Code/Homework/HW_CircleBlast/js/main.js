...
//Note that we are starting the game, by calling setUp(),
//AFTER we have pre-loaded all of our image assets.
app.loader.load();
...
function end() {
	...
	gameOverScoreLabel = new PIXI.Text("Your final score is: "+score);
	let textStyle = new PIXI.TextStyle({
		fill: 0xFFFFFF,
		fontSize: 30,
		fontFamily: "Futura",
...
function fireBullet(e) {
	...
	if(score > 5){
        b = new Bullet(0xFFFFFFF, ship.x - 10, ship.y);
        bullets.push(b);
        gameScene.addChild(b);
